...
import json
with open('module-10-assignment-train-idx.json', 'r') as f: # Reads the list of most frequent words
    train_idx = json.load(f)
with open('module-10-assignment-validation-idx.json', 'r') as f1: # Reads the list of most frequent words
